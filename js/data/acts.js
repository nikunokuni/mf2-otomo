...
/* ===========================================================
   ...
   イベントごとの決まりごと
     大会 週経過1。追加は 体調値ぶん + 大会ぶん
     修行 週経過4。追加は 体調値ぶんだけ（修行そのものの追加は無い）。
          4週まとめて1回、修行が終わった時点の体調値で数える。
          疲労0・ストレス0から始めれば 4週 + 体調値ぶん3 = -7 となり、
          育成計画の EV_COST.mc と一致する
     冒険 週経過0（4週たつが、ここだけ寿命に数えない）。追加は 冒険ぶんだけ
          （出かけているあいだは体調値を出さない）
   =========================================================== */
...
/**
 * イベントそのものにかかる追加ぶん（体調値ぶんとは別に、加えてかかる）。
 *   weeks    暦が進む週数
 *   ageWeeks そのうち寿命に数える週経過（冒険だけ0）
 *   extra    イベント1回まるごとでかかる追加ぶん
 */
